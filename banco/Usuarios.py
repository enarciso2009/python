...
class Usuarios(object):
    ...
    def __init__(self, idusuario = 0, nome = "", telefone = "", email = "", usuario = "", senha = ""):
        self.info = {}
        self.idusuario = '1' # idusuario
        self.nome = 'Everton' #nome
        self.telefone = '3232323' #telefone
        self.email = 'enarciso2009@gmail.com' #email
        self.usuario = 'everton' #usuario
        self.senha = '1234' #senha
